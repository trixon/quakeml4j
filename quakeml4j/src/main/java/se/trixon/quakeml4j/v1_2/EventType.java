 ...
 * <
 * pre>
 * &lt;simpleType name="EventType"&gt; &lt;restriction
 * base="{http://www.w3.org/2001/XMLSchema}string"&gt; &lt;enumeration
 * value="not existing"/&gt; &lt;enumeration value="not reported"/&gt;
 * &lt;enumeration value="earthquake"/&gt; &lt;enumeration value="anthropogenic
 * event"/&gt; &lt;enumeration value="collapse"/&gt; &lt;enumeration
 * value="cavity collapse"/&gt; &lt;enumeration value="mine collapse"/&gt;
 * &lt;enumeration value="building collapse"/&gt; &lt;enumeration
 * value="explosion"/&gt; &lt;enumeration value="accidental explosion"/&gt;
 * &lt;enumeration value="chemical explosion"/&gt; &lt;enumeration
 * value="controlled explosion"/&gt; &lt;enumeration value="experimental
 * explosion"/&gt; &lt;enumeration value="industrial explosion"/&gt;
 * &lt;enumeration value="mining explosion"/&gt; &lt;enumeration value="quarry
 * blast"/&gt; &lt;enumeration value="road cut"/&gt; &lt;enumeration
 * value="blasting levee"/&gt; &lt;enumeration value="nuclear explosion"/&gt;
 * &lt;enumeration value="induced or triggered event"/&gt; &lt;enumeration
 * value="rock burst"/&gt; &lt;enumeration value="reservoir loading"/&gt;
 * &lt;enumeration value="fluid injection"/&gt; &lt;enumeration value="fluid
 * extraction"/&gt; &lt;enumeration value="crash"/&gt; &lt;enumeration
 * value="plane crash"/&gt; &lt;enumeration value="train crash"/&gt;
 * &lt;enumeration value="boat crash"/&gt; &lt;enumeration value="other
 * event"/&gt; &lt;enumeration value="atmospheric event"/&gt; &lt;enumeration
 * value="sonic boom"/&gt; &lt;enumeration value="sonic blast"/&gt;
 * &lt;enumeration value="acoustic noise"/&gt; &lt;enumeration
 * value="thunder"/&gt; &lt;enumeration value="avalanche"/&gt; &lt;enumeration
 * value="snow avalanche"/&gt; &lt;enumeration value="debris avalanche"/&gt;
 * &lt;enumeration value="hydroacoustic event"/&gt; &lt;enumeration value="ice
 * quake"/&gt; &lt;enumeration value="slide"/&gt; &lt;enumeration
 * value="landslide"/&gt; &lt;enumeration value="rockslide"/&gt; &lt;enumeration
 * value="meteorite"/&gt; &lt;enumeration value="volcanic eruption"/&gt;
