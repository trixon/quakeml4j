...
/**
 * <p>
 * Java class for OriginDepthType.
 *
 * <p>
 ...
 * <
 * pre>
 * &lt;simpleType name="OriginDepthType"&gt; &lt;restriction
 * base="{http://www.w3.org/2001/XMLSchema}string"&gt; &lt;enumeration
 * value="from location"/&gt; &lt;enumeration value="from moment tensor
 * inversion"/&gt; &lt;enumeration value="from modeling of broad-band P
 * waveforms"/&gt; &lt;enumeration value="constrained by depth phases"/&gt;
 * &lt;enumeration value="constrained by direct phases"/&gt; &lt;enumeration
 * value="constrained by depth and direct phases"/&gt; &lt;enumeration
 * value="operator assigned"/&gt; &lt;enumeration value="other"/&gt;
